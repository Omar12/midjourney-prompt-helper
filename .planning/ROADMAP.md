...
- [ ] 02-01-PLAN.md — Flag domain module: Zod schemas, VERSION_DEFINITIONS, FLAG_DEFINITIONS, helpers (getFlagsForVersion, serializeFlag, validateAspectRatio) + tests
...
| 2. Data-Driven Flag Controls | 0/6 | Not started | - |
